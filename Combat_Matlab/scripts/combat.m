...
function [bayesdata,var_pooled,stand_mean,gamma_star,delta_star] = combat(dat, batch, mod, parametric)
...
%     var_pooled stand_mean gamma_star delta_star
%      Harm(:,1) = (bayesdata(:,1)-(batch_design(group,:)*gamma_star)')./(sqrt(delta_star(group,:))'*repmat(1,1,n_batches(group)));
